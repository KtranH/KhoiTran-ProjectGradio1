    ...
    with gr.Blocks() as tab5:
        with gr.Row():
            with gr.Column():
                ...
                blink = gr.Slider(label="Nháy mắt (Nhắm mắt: số âm, Mở mắt: số dương)", value=0, maximum=2, minimum=-2, step=1)
                ...
                smile = gr.Slider(label="Mỉm cười (Không cười: số âm, Mỉm cười: số dương)", value=0, maximum=1.3, minimum=-0.3, step=1)         
            with gr.Column():
